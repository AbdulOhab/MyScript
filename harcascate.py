...
# file path
path = "E:\\#Research_Info\\video_dataset_folder_male\\image_dataset_two\\*.*"
...
for file in image_list:
    ...
    try:
        ...
        cv2.imwrite("E:\\#Research_Info\\video_dataset_folder_male\\extracted_faces_dataset_two/" + str(image_number) + ".png", resized)
    except:
